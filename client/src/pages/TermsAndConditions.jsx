    ...
    return (
        <div className='py-10 mx-auto max-w-7xl'>
            <div className='text-center'>
                <h1 className='text-4xl text-[#140342] font-bold'>Terms & Conditions</h1>
                <p className='text-gray-700 py-5 text-md'>We as in Tech Minds Education are on a mission to provide quality interactive learning experience to its learner with best support.</p>
            </div>
            <div className='my-12'>
                <h2 className='text-xl font-semibold text-[#140342]'>Terms And Condition.</h2>
                <ul className='my-8'>
                    <li className='my-8 text-gray-700'>Welcome to Tech Minds Education!</li>
                    <li className='my-8 text-gray-700'>These terms and conditions outline the rules and regulations for the use of Tech Minds Education’s Website, located at https://techmindseducation.com/.</li>
                    <li className='my-8 text-gray-700'>By accessing this website we assume you accept these terms and conditions. Do not continue to use Tech Minds Education if you do not agree to take all of the terms and conditions stated on this page.</li>
                </ul>
            ...
            <div>
                <h3 className='text-xl text-[#140342] font-semibold mb-8'>Term And Termination</h3>
                <p className='text-gray-700 leading-8'>
            ...
            <div className='my-12'>
                <h3 className='text-xl text-[#140342] font-semibold mb-8'>Indemnity</h3>
                <p className='text-gray-700 leading-8'>
            ...
            <div>
                <h3 className='text-xl text-[#140342] font-semibold mb-8'>Waiver</h3>
                <p className='text-gray-700 leading-8'>
            ...
            <div className='my-12'>
                <h3 className='text-xl text-[#140342] font-semibold mb-8'>Severability</h3>
                <p className='text-gray-700 leading-8'>
