...
const TermsAndConditions = () => {
    return (
        <div className='py-6 md:py-10 px-4 md:px-6 lg:px-0 mx-auto max-w-7xl'>
            <div className='text-center'>
                <h1 className='text-2xl md:text-3xl lg:text-4xl text-[#140342] font-bold'>Terms & Conditions</h1>
                <p className='text-gray-700 py-3 md:py-5 text-sm md:text-md'>We as in Tech Minds Education are on a mission to provide quality interactive learning experience to its learner with best support.</p>
            </div>

            <div className='my-6 md:my-12'>
                <h2 className='text-lg md:text-xl font-semibold text-[#140342]'>Terms And Condition.</h2>
                <ul className='my-4 md:my-8'>
                    <li className='my-4 md:my-8 text-gray-700 text-sm md:text-base'>Welcome to Tech Minds Education!</li>
                    <li className='my-4 md:my-8 text-gray-700 text-sm md:text-base'>These terms and conditions outline the rules and regulations for the use of Tech Minds Education's Website, located at https://techmindseducation.com/.</li>
                    <li className='my-4 md:my-8 text-gray-700 text-sm md:text-base'>By accessing this website we assume you accept these terms and conditions. Do not continue to use Tech Minds Education if you do not agree to take all of the terms and conditions stated on this page.</li>
                </ul>
            ...
            <div>
                <h3 className='text-lg md:text-xl font-semibold text-[#140342] mb-4 md:mb-8'>Terms Of Services.</h3>
                <ul className='list-disc pl-5 md:pl-10 text-gray-700 text-sm md:text-base'>
                    <li>
                    ...
                    <li className='my-2 md:my-3 leading-7 md:leading-8'>
                    ...
                    <li className='leading-7 md:leading-8'>
                    ...
                    <li className='mt-2 md:mt-3 leading-7 md:leading-8'>
            ...
            <div className='my-6 md:my-12'>
                <h3 className='text-lg md:text-xl text-[#140342] font-semibold mb-4 md:mb-8'>Usage Of The Website And Services</h3>
                <p className='text-gray-700 text-sm md:text-base leading-7 md:leading-8'>
                ...
                <p className='my-4 md:my-8 text-gray-700 text-sm md:text-base leading-7 md:leading-8'>You Are Permitted Online Access To The Website, The Services, And The Content And Courseware And May Download, Save, Or Print The Content And Courseware Solely For The Restricted Purpose.</p>
                <p className='text-gray-700 text-sm md:text-base leading-7 md:leading-8'>You Are Not Permitted To Reproduce, Transmit, Distribute, Sub-License, Broadcast, Disseminate, Or Prepare Derivative Works Of The Content And Courseware, Or Any Part Thereof, In Any Manner Or Through Any Communication Channels Or Means, For Any Purpose Other Than The Restricted Purpose, Without Our Prior Written Consent.</p>
            </div>

            <div>
                <h3 className='text-lg md:text-xl text-[#140342] font-semibold mb-4 md:mb-8'>Content and Courseware.</h3>
                <p className='text-gray-700 text-sm md:text-base leading-7 md:leading-8 mb-4 md:mb-8'>
                ...
                <p className='text-gray-700 text-sm md:text-base leading-7 md:leading-8'>We Reserve The Right To Amend, Revise Or Update The Content And Courseware Offered To You. In The Event Such An Amendment, Revision Or Updating Occurs, We May Require You Pay An Additional Fee To Access Such Amended, Revised, Or Updated Content And Courseware.</p>
            </div>

            <div className='my-6 md:my-12'>
                <h3 className='text-lg md:text-xl text-[#140342] font-semibold mb-4 md:mb-8'>Usage Of Personal Information Of Participants</h3>
            ...
            <div>
                <h3 className='text-lg md:text-xl text-[#140342] font-semibold mb-4 md:mb-8'>Term And Termination</h3>
                <p className='text-gray-700 text-sm md:text-base leading-7 md:leading-8'>
            ...
            <div className='my-6 md:my-12'>
                <h3 className='text-lg md:text-xl text-[#140342] font-semibold mb-4 md:mb-8'>Indemnity</h3>
                <p className='text-gray-700 text-sm md:text-base leading-7 md:leading-8'>
            ...
            <div>
                <h3 className='text-lg md:text-xl text-[#140342] font-semibold mb-4 md:mb-8'>Waiver</h3>
                <p className='text-gray-700 text-sm md:text-base leading-7 md:leading-8'>
            ...
            <div className='my-6 md:my-12'>
                <h3 className='text-lg md:text-xl text-[#140342] font-semibold mb-4 md:mb-8'>Severability</h3>
                <p className='text-gray-700 text-sm md:text-base leading-7 md:leading-8'>
            ...
            <div>
                <h3 className='text-lg md:text-xl text-[#140342] font-semibold mb-4 md:mb-8'>Governing Law And Jurisdiction</h3>
                <p className='text-gray-700 text-sm md:text-base leading-7 md:leading-8'>For All Participants, This Agreement Shall Be Governed By And Construed In Accordance With The Laws Of India And The Courts In Uttar Pradesh, India Shall Have The Exclusive Jurisdiction Over Any Matter Relating To, In Connection With, Or Arising Out Of, This Agreement.</p>
            </div>

            <div className='my-6 md:my-12'>
                <h3 className='text-lg md:text-xl text-[#140342] font-semibold mb-4 md:mb-8'>Entire Agreement</h3>
                <p className='text-gray-700 text-sm md:text-base leading-7 md:leading-8'>This Agreement, Along With The Privacy Policy, Refund Policy, Rescheduling Policy, Terms Of Use, And Any Additional Guidelines, Rules, And/or Disclaimers Posted On The Website Constitutes The Entire Agreement Governing Your Use Of Our Website And Supersedes Any Prior Agreements, If Any, Relating To Any Matter Dealt Within This Agreement.</p>
            </div>

            <div>
                <h3 className='text-lg md:text-xl text-[#140342] font-semibold mb-4 md:mb-8'>Job Guarantee Programs</h3>
                <p className='text-gray-700 text-sm md:text-base leading-7 md:leading-8'>In case you have enrolled to our Job Guaranteed Program Please read our Job Guaranteed Programs terms and condition prior to your enrolment.</p>
            </div>

            <div className='mb-6'>
                <h3 className='text-lg md:text-xl text-[#140342] font-semibold mb-4 md:mb-8'>Grievance Redressal</h3>
                <p className='text-gray-700 text-sm md:text-base leading-7 md:leading-8'>In Case You Have Any Concerns Or Queries, Please Reach Out To Our Grievance Team. Our Grievance Officer Shall Undertake All Reasonable Efforts To Address Your Grievances In The Shortest Possible Time. You May Contact Us At following.</p>
                <p className='my-3 md:my-5 text-sm md:text-base'>Grievance Officer:- Munu Bhat.</p>
                <p className='text-sm md:text-base'>Email Id:- support@techmindseducation.com</p>
            </div>
        </div>
    )
}
