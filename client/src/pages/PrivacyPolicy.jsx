...
const PrivacyPolicy = () => {
  return (
    <div className='py-6 md:py-10 px-4 md:px-8 mx-auto max-w-7xl'>
      <div>
        <h1 className='text-3xl md:text-4xl text-[#140342] font-bold'>Privacy policy.</h1>
        <p className='text-gray-700 py-3 md:py-5 text-md font-bold'>Purpose</p>
        <p className='text-gray-700 text-sm md:text-md'>Tech Minds Education (Tech Minds Education "we," "us," or "our") is committed to protecting your privacy, we take data protection and privacy very seriously.</p>
        <p className='mt-3 text-gray-700 text-sm md:text-base leading-7 md:leading-8'>
          This Privacy Policy ("Policy") describes how we collect, use, share and secure the personal information you provide when you visit the Websites owned and operated by us (listed below), and when you use our Service(s). It also describes your choices regarding use, access, withdrawal of consent (as per the terms hereof) and correction of your personal information. The use of information collected through our Service(s) shall be limited to the purpose of
          providing the service that you have chosen. The capitalized terms used in this Policy but not defined herein shall have the same meaning as defined in our Terms and Conditions at ("Terms and Conditions "). For the purpose of this Privacy Policy, sensitive personal data or information of a personal nature is as defined under applicable privacy laws. Please note that usage of the terms personal information/ personally identifiable information/ personal data, in this Privacy Policy includes sensitive personal data or
          information, wherever appropriate and/or mandated under applicable privacy laws.
        </p>
      </div>
      <div className='my-8 md:my-12'>
        <h3 className='text-lg md:text-xl text-[#140342] font-semibold mb-4'>Tech Minds Education website.</h3>
        <p className='text-gray-700 text-sm md:text-base'>Website:- www.techmindseducation.com</p>
        <p className='text-gray-700 text-sm md:text-base mt-5'>Please read this Privacy Policy carefully, as it governs how you use our website or its affiliate products. If you do not agree to this Privacy Policy, please do not use our Services.</p>
      </div>
      <div>
        <h3 className='text-lg md:text-xl font-semibold text-[#140342] mb-4'>Notice to End Users</h3>
        <p className='text-gray-700 text-sm md:text-base leading-7 md:leading-8'>In Some Cases An Administrator May Create An Account In Tech Minds Education On The Behalf Of An "End-User" And May Provide His/Her Information, Including Personal Information. In Such Cases The Administrator Who May Be Your Employer Or a tech minds Education Authorized Training Partner (ATP) Is Our "Customer." We Collect Information Under The Direction Of Our Customers And Have No Direct Relationship With The End-User Whose Personal Data We Process.</p>
        <p className='my-3 md:my-5 text-gray-700 text-sm md:text-base'>An End-User's Use Of our website or Platform May Be Subject To The Customer's Policies, If Any.</p>
        <p className='text-gray-700 text-sm md:text-base leading-7 md:leading-8'>Our Customer Must Have The Authority To Act On Behalf Of The End-User And To Consent To The Collection And Use Of Their Personal Information As Described In This Privacy Policy. If You Are An End-User Using Our Platform, Please Direct Your Privacy Inquiries To Your Administrator. Tech Minds Education Is Not Responsible For The Privacy Or Security Practices Of Our Customers, Which May Differ From Those Set Forth In This Privacy Statement.</p>
        <p className='text-gray-700 text-sm md:text-base mt-3 md:mt-5'>We Do Not Send Personalized Advertisement Or Marketing Communication To End Users.</p>
      </div>
      <div className='my-8 md:my-12'>
        <h3 className='text-lg md:text-xl font-semibold text-[#140342] mb-4'>Use of your Personal Information and Other Data.</h3>
        <p className='text-gray-700 text-sm md:text-base leading-7 md:leading-8'>Tech Minds Education uses this Privacy Policy to govern the use of personal information you provide to us. We use your personal information solely to provide our services to you. We also use your Personal Identifiable Information (PII) together with other Personally Non-Identifiable Information (Non – PII) To Help Us Better Understand Our Users And To Improve The Content And Functionality Of Our Site.</p>
      </div>
      <div>
        <h3 className='text-lg md:text-xl font-semibold text-[#140342] mb-4'>Personal Identifiable Information</h3>
        <p className='text-gray-700 text-sm md:text-base'>We may collect the following personal information from you in the following situations:-</p>
        <ul className='my-4 list-disc text-gray-700 text-sm md:text-base ml-5 md:ml-8'>
          ...
          <li className='my-2'>Contact Information, Such As Name, Email Address, Mailing Address, Phone Number, IP</li>
          <li className='my-2'>Information about your business, such as company name, company size, business type.</li>
          <li>Your account details which may include billing information and the account password.</li>
        </ul>
        <p className='text-gray-700 text-sm md:text-base'>Note: All payment transactions are processed through secure payment gateway providers. We do not store any card information (other than the last 4 digits of your card) in our servers.</p>
        <p className='text-gray-600 text-sm md:text-base leading-7 md:leading-8 my-3 md:my-5'>
      ...
      <div>
        <h3 className='text-lg md:text-xl font-semibold text-[#140342] mb-4'>USE</h3>
        <p className='text-gray-600 text-sm md:text-base leading-7 md:leading-8 my-3 md:my-5'>We may use the personal information collected from within the Websites, chat box, mobile, email or when you use the Service(s) to:</p>
        <ul className='list-disc ml-5 md:ml-8 text-gray-700 text-sm md:text-base'>
          ...
          <li className='leading-7 md:leading-8 mb-2'>
        ...
        <p className='mt-3 md:mt-5 text-gray-700 text-sm md:text-base'>
      ...
      <div className='my-8 md:my-12'>
        <h3 className='text-lg md:text-xl font-semibold text-[#140342] mb-4'>Share</h3>
        <p className='text-gray-700 text-sm md:text-base'>If Your Subscription Was Provided By Your Employer or a Tech Minds Education Authorized Training Partner, We Will Share Information, Including Personal Information With Them.</p>
        <p className='leading-7 md:leading-8 text-gray-700 text-sm md:text-base my-3 md:my-5'>We may transfer personal information to our affiliates and sub-contractors that help us provide our Service(s). Transfers to subsequent third parties are covered by the service agreements with our data-processors. We reserve the right to disclose your personal data as required by applicable law, in response to lawful requests by public authorities, including meeting national security or law enforcement requirements and when we believe that disclosure is necessary to protect our rights and/or to comply with a judicial proceeding, court order, or other legal process served on us.</p>
        <p className='text-gray-700 text-sm md:text-base leading-7 md:leading-8'>In the event we go through a business transition, such as a merger or acquisition by another company, or sale of all or a portion of our assets, your user account and personal data will likely be among the assets transferred. We may also disclose your personal information to any other third party with your prior consent.</p>
      </div>
      <div>
        <h3 className='text-lg md:text-xl font-semibold text-[#140342] mb-4'>Data from Third Parties</h3>
        <p className='text-gray-700 text-sm md:text-base leading-7 md:leading-8'>
        ...
        <ul className='ml-5 md:ml-8 text-gray-700 text-sm md:text-base list-disc my-3 md:my-5'>
          <li className='mb-2'>Data brokers from which we purchase demographic data to supplement the data we collect.</li>
          <li className='mb-2'>Social networks when you grant permission to make your data public on these networks including, permission to access your data on one or more of these networks.</li>
          <li className='mb-2'>An enterprise customer where you are an employee using our services.</li>
          <li className='mb-2'>Existing or past learners who participate in our referral program</li>
          <li className='mb-2'>Service providers that help us determine a location based on your IP address in order to customize certain products to your location.</li>
          <li className='mb-2'>Partners with which we offer co-branded services or engage in joint marketing activities, and</li>
          <li className='mb-2'>Publicly-available sources such as open government databases or other data in the public domain.</li>
        </ul>
        <p className='text-gray-700 text-sm md:text-base leading-7 md:leading-8'>We may receive Personal Information about you from other sources like postal mail, telephone or fax. We may add this information to the information we have already collected from you via the Site in order to improve the products and services we provide.</p>
      </div>
      <div className='my-8 md:my-12'>
        <h3 className='text-lg md:text-xl font-semibold text-[#140342] mb-4'>Rights to access, correction and deletion of Personal Information</h3>
        <p className='leading-7 md:leading-8 text-gray-700 text-sm md:text-base'>
        ...
        <p className='text-gray-700 text-sm md:text-base my-3 md:my-5'><b>Right to access: </b>We acknowledge that you have the right to access your Personal Information at any time. Upon such request to access, we will provide you with reasonable access to the Personal Information we collect about you.</p>
        <p className='text-gray-700 text-sm md:text-base leading-7 md:leading-8'>
        ...
        <p className='my-3 md:my-5 text-gray-700 text-sm md:text-base leading-7 md:leading-8'>
          <b>Right to Correction:</b> We acknowledge that you have the right to either edit, correct/amend or update any inaccurate or incomplete Personal Information along with the supporting documentation. We provide access to either edit, correct/amend or update your Personal Information at any time by logging into your account. Even after your edit, correct/amend or update to your Personal Information, we may maintain and store older versions of such personal
        ...
        <p className='text-gray-700 text-sm md:text-base leading-7 md:leading-8'>Where the processing of your Personal Information is based on your consent, you have the right to withdraw your consent granted for processing of your Personal Information by issuing a written request to the Grievance officer.</p>
        <p className='text-gray-700 text-sm md:text-base my-3 md:my-5'>You will have the opportunity to edit correct, amend, update or delete your Personal Information or withdraw your consent as follows:</p>
        <ul className='list-disc ml-5 md:ml-8 text-gray-700 text-sm md:text-base'>
          <li className='mb-3 md:mb-4'>If you have independently signed up for our Services, you may access, update or export your Personal Information included in your online account at any time by logging into your account and going to your profile or by reaching out to us.</li>
      ...
      <div>
        <h3 className='text-lg md:text-xl font-semibold text-[#140342] mb-4'>Data Subject's Rights To Complain</h3>
        <p className='text-gray-700 text-sm md:text-base'>Users in the European Economic Area ("EEA") and United Kingdom ("UK")</p>
        <p className='leading-7 md:leading-8 text-gray-700 text-sm md:text-base my-3 md:my-5'>
      ...
      <div>
        <h3 className='text-lg md:text-xl font-semibold text-[#140342] mb-4'>USERS IN CALIFORNIA</h3>
        <p className='text-gray-700 text-sm md:text-base leading-7 md:leading-8'>
      ...
      <div className='my-8 md:my-12'>
        <h3 className='text-lg md:text-xl font-semibold text-[#140342] mb-4'>Cookies and Other Tracking Technologies.</h3>
        <p className='text-gray-700 text-sm md:text-base leading-7 md:leading-8'>
        ...
        <p className='text-gray-700 text-sm md:text-base my-3 md:my-5'>The Types of Cookies we use includes:</p>
        <p className='text-gray-700 text-sm md:text-base'><b>Essential Cookies:</b> These Cookies Are Essential for The Basic Functionalities Offered by The Site and Service(S). These Classes of Cookies Helps in Keeping a User Logged in To the Service(S) And Remember Relevant Information When They Return to The Service(S).</p>
        <p className='text-gray-700 text-sm md:text-base my-3 md:my-5'><b>Insight Cookies:</b> These Are Used for Tracking the User Activities Within the Service(S), Which in Turn Helps Us in Improving Your User Experience.</p>
        <p className='text-gray-700 text-sm md:text-base'><b>Marketing Cookies:</b> These Are Used for Providing You with Customized and Interest-Based Ads Based on Your Browsing Behavior and Other Similar Activities on Our Websites.</p>
        <p className='text-gray-700 text-sm md:text-base my-3 md:my-5 leading-7 md:leading-8'>You can choose to have your computer warn you each time a cookie is being sent, or you can choose to turn off all cookies. You do this through your browser settings. Since each browser is different, look at your browser's Help Menu to learn the correct way to modify your cookies.</p>
        <p className='text-gray-700 text-sm md:text-base'>If You Turn Cookies Off, Some of The Features That Make Your Site Experience More Efficient May Not Function Properly.</p>
      </div>
      <div>
        <h3 className='text-lg md:text-xl font-semibold text-[#140342] mb-4'>ADVERTISEMENT</h3>
        <p className='text-gray-700 text-sm md:text-base leading-7 md:leading-8'>
      ...
      <div className='my-8 md:my-12'>
        <h3 className='text-lg md:text-xl font-semibold text-[#140342] mb-4'>DO NOT TRACK.</h3>
        <p className='text-gray-700 text-sm md:text-base leading-7 md:leading-8'>
      ...
      <div>
        <h3 className='text-lg md:text-xl font-semibold text-[#140342] mb-4'>LINKS TO THIRD PARTY SITES</h3>
        <p className='leading-7 md:leading-8 text-gray-700 text-sm md:text-base'>
      ...
      <div className='my-8 md:my-12'>
        <h3 className='text-lg md:text-xl font-semibold text-[#140342] mb-4'>Public Forums</h3>
        <p className='leading-7 md:leading-8 text-gray-700 text-sm md:text-base'>
        ...
        <p className='text-gray-700 text-sm md:text-base my-3 md:my-5'>Remember that when you share information publicly, it may be index able by search engines.</p>
      </div>
      <div>
        <h3 className='text-lg md:text-xl font-semibold text-[#140342] mb-4'>Single Sign-On & Other social Media Features</h3>
        <p className='leading-7 md:leading-8 text-gray-700 text-sm md:text-base'>
        ...
        <p className='my-3 md:my-5 text-gray-700 text-sm md:text-base'>
      ...
      <div className='my-8 md:my-12'>
        <h3 className='text-lg md:text-xl font-semibold text-[#140342] mb-4'>COMMUNICATIONS FROM THE WEBSITES</h3>
        <p className='leading-7 md:leading-8 text-gray-700 text-sm md:text-base'>
      ...
      <div>
        <h3 className='text-lg md:text-xl font-semibold text-[#140342] mb-4'>Information Security</h3>
        <p className='leading-7 md:leading-8 text-gray-700 text-sm md:text-base'>
      ...
      <div className='my-8 md:my-12'>
        <h3 className='text-lg md:text-xl font-semibold text-[#140342] mb-4'>TESTIMONIALS</h3>
        <p className='leading-7 md:leading-8 text-gray-700 text-sm md:text-base'>
      ...
      <div>
        <h3 className='text-lg md:text-xl font-semibold text-[#140342] mb-4'>Children's Personal Information</h3>
        <p className='leading-7 md:leading-8 text-gray-700 text-sm md:text-base'>
      ...
      <div className='my-8 md:my-12'>
        <h3 className='text-lg md:text-xl font-semibold text-[#140342] mb-4'>Amendments</h3>
        <p className='leading-7 md:leading-8 text-gray-700 text-sm md:text-base'>
